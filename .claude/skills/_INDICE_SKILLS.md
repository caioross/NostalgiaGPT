...
| Skill | Quando usar |
|---|---|
| `nostalgia-content` | Criar nova personalidade no array `PEOPLE` de `js/personalities.js`, escrever `tagline` e `starters` coerentes com a época, curar fontes e datas, corrigir anacronia, validar metadados (categoria inexistente, foto ausente, starters fora de 3–5, nome/slug duplicado), escalar além das 47 personalidades atuais. |
